...
export const handleApproval = async (
  ...
  try {
    ...
    // const path=await db.path.findMany({
    //   where:{
    //     eva
    //   }
    // })
    ...
    for (const p of allPaths) {
      ...
      const subject = "Path update";
  const bodyText = `${intermediary.name} has approved your path.`;
  const bodyHtml = `
...
@media screen and (max-width:384px) {.mail-message-content { width:414px!important } }</style>
 ...
 <body class="body" style="width:100%;height:100%;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
               ...
               <table cellspacing="0" cellpadding="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table cellspacing="0" cellpadding="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" class="a" style="padding:0;Margin:0"><h2 class="z c b" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:24px;font-style:normal;font-weight:normal;line-height:28.8px;color:#000000">Path Update</h2></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellspacing="0" cellpadding="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:590px">
                   <table cellspacing="0" cellpadding="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" bgcolor="#ffffff" style="padding:0;Margin:0;padding-top:15px;padding-right:25px;padding-bottom:10px"><h3 class="z" style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:20px;font-style:normal;font-weight:normal;line-height:24px;color:#000000">${intermediary.name}</h3></td>
                     </tr>
                     <tr>
                      <td align="center" bgcolor="#ffffff" style="padding:0;Margin:0;padding-right:25px;padding-bottom:10px;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#000000;font-size:14px">has approved your path</p></td>
  ...
  `;
     ...
     await sendEmail(request?.requester?.email, subject, bodyText, bodyHtml);
     if(nextPath?.intermediary?.email){
        await sendEmail(nextPath?.intermediary?.email, subject, bodyText, bodyHtml);
     }
