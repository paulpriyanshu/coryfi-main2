...
function SignupComponent() {
 ...
 const handleSignin = async () => {
  ...
  // Normal Signup UI
  return (
    <div className="min-h-screen flex items-center justify-center dark:bg-black bg-gradient-to-br from-gray-100 via-gray-200 to-gray-300">
      <div className="w-full max-w-md p-6 bg-white dark:bg-black rounded-lg shadow-xl">
        {/* Header */}
        <div className="text-center dark:text-white">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <a
              href="#"
              className="font-medium text-blue-600 hover:underline  dark:text-white"
