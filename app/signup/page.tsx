        ...
        <Card>
          ...
          <CardContent>
            <form className="space-y-6" action="#" method="POST">
              ...
              <div>
                <div typeof="email">Email address</div>
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div>
                <div typeof="password">Password</div>
                <div className="mt-1 relative rounded-md shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
          ...
          <CardFooter>
            <button className="w-full flex justify-center py-2 px-4 bg-blue-500 text-white font-bold text-xl hover:bg-blue-400">
              Sign up
